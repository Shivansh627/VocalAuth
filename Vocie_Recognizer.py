...
"color:white;")
        ...
        self.Start_Recording_Button = QtWidgets.QPushButton(self.groupBox, clicked=lambda: MAESTRO.record_and_predict())
        ...
        self.Register_User_Button = QtWidgets.QPushButton(self.groupBox, clicked=lambda: MAESTRO.register_user_voice())
        self.Register_User_Button.setMinimumSize(QtCore.QSize(143, 29))
        self.Register_User_Button.setMaximumSize(QtCore.QSize(160, 16777215))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.Register_User_Button.setFont(font)
        self.Register_User_Button.setStyleSheet("background-color:#33cc33;")
        self.Register_User_Button.setText("Register Voice")
        self.gridLayout_5.addWidget(self.Register_User_Button, 1, 0, 1, 1)
    ...
    def retranslateUi(self, Voice_Recognizer):
        ...
        self.label.setText(_translate("Voice_Recognizer", "VocalAuth"))
